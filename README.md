...
1. Оператор открывает левую панель со списком заявок
2. Выбирает нужную заявку
3. В правой панели видит статус обработки
4. Работает с ответом AI в чате
5. Отправляет готовый ответ клиенту
